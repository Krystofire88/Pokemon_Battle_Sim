...
public class Species
{
    ...
    "Calm", "Gentle", "Sassy", "Careful", "Quirky"
        ...
        public void MegaEvolve()
        {
            ...
            foreach (Species s in AllPokemon.Skip(AllPokemon.Count - 75))
            {
                ...
                {
                    Console.Write($"{species.name} mega evolved into ");
                    species = s;
        ...
        public void UnMegaEvolve()
        {
            string json = File.ReadAllText("AllPokemon.json");
            List<Species> AllPokemon = JsonSerializer.Deserialize<List<Species>>(json);
            if (species.name == "Charizard-Mega-X")
            {
                species = AllPokemon.Find(sp => sp.name == "Charizard");
                return;
            }
            else if (species.name == "Charizard-Mega-Y")
            {
                species = AllPokemon.Find(sp => sp.name == "Charizard");
                return;
            }
            else if (species.name == "Mewtwo-Mega-X")
            {
                species = AllPokemon.Find(sp => sp.name == "Mewtwo");
                return;
            }
            else if (species.name == "Mewtwo-Mega-Y")
            {
                species = AllPokemon.Find(sp => sp.name == "Mewtwo");
                return;
            }
    ...
    public static class Program
    {
        ...
        public static int FindBestMove(Pokemon atk, Pokemon opp)
        {
            ...
            {
                if (HighestEffect < Damage(atk, opp, atk.moveSet[i], DecodeEffect(atk.moveSet[i].moveB.effect, 2), atk.CalcAtkStat(), opp.CalcDefStat() * opp.GetMod(opp.DefMod), 1.0, 23, true))
                {
                    HighestEffect = Damage(atk, opp, atk.moveSet[i], DecodeEffect(atk.moveSet[i].moveB.effect, 2), atk.CalcAtkStat(), opp.CalcDefStat() * opp.GetMod(opp.DefMod), 1.0, 23, true);
                }
            }
    ...
    "Calm", "Gentle", "Sassy", "Careful", "Quirky"
            ...
            List<MoveB> AllMoves = new List<MoveB>
        {
          ...
          new MoveB("NormalP", 1, 1, 100, 20, "01&60"),
          new MoveB("NormalS", 1, 2, 100, 20, "01&60"),
          new MoveB("FireP",     2, 1, 100, 20, "01&60"),
          new MoveB("FireS",     2, 2, 100, 20, "01&60"),
          new MoveB("WaterP",    3, 1, 100, 20, "01&60"),
          new MoveB("WaterS",    3, 2, 100, 20, "01&60"),
          new MoveB("ElectricP", 4, 1, 100, 20, "01&60"),
          new MoveB("ElectricS", 4, 2, 100, 20, "01&60"),
          new MoveB("GrassP",    5, 1, 100, 20, "01&60"),
          new MoveB("GrassS",    5, 2, 100, 20, "01&60"),
          new MoveB("IceP",      6, 1, 100, 20, "01&60"),
          new MoveB("IceS",      6, 2, 100, 20, "01&60"),
          new MoveB("FightingP", 7, 1, 100, 20, "01&60"),
          new MoveB("FightingS", 7, 2, 100, 20, "01&60"),
          new MoveB("PoisonP",   8, 1, 100, 20, "01&60"),
          new MoveB("PoisonS",   8, 2, 100, 20, "01&60"),
          new MoveB("GroundP",   9, 1, 100, 20, "01&60"),
          new MoveB("GroundS",   9, 2, 100, 20, "01&60"),
          new MoveB("FlyingP",  10, 1, 100, 20, "01&60"),
          new MoveB("FlyingS",  10, 2, 100, 20, "01&60"),
          new MoveB("PsychicP", 11, 1, 100, 20, "01&60"),
          new MoveB("PsychicS", 11, 2, 100, 20, "01&60"),
          new MoveB("BugP",     12, 1, 100, 20, "01&60"),
          new MoveB("BugS",     12, 2, 100, 20, "01&60"),
          new MoveB("RockP",    13, 1, 100, 20, "01&60"),
          new MoveB("RockS",    13, 2, 100, 20, "01&60"),
          new MoveB("GhostP",   14, 1, 100, 20, "01&60"),
          new MoveB("GhostS",   14, 2, 100, 20, "01&60"),
          new MoveB("DragonP",  15, 1, 100, 20, "01&60"),
          new MoveB("DragonS",  15, 2, 100, 20, "01&60"),
          new MoveB("DarkP",    16, 1, 100, 20, "01&60"),
          new MoveB("DarkS",    16, 2, 100, 20, "01&60"),
          new MoveB("SteelP",   17, 1, 100, 20, "01&60"),
          new MoveB("SteelS",   17, 2, 100, 20, "01&60"),
          new MoveB("FairyP",   18, 1, 100, 20, "01&60"),
          new MoveB("FairyS",   18, 2, 100, 20, "01&60"),
        };
                    ...
                    List<int> invalidMon = new List<int>
                {
                    ...
                    foreach (Species s in AllPokemon)
                    {
                        ...
                        if ((!invalidMon.Contains(g)) && g < 1158)
                        {
                            ...
                            if (s.Atk > s.Spa)
                            {
                                MoveB a = new MoveB("Physical", s.type1, 1, 100, 100, "01&60");
                                Move a1 = new Move(a);
                                temp.AddMove(a1);
                                if (s.type2 != 0)
                                {
                                    a = new MoveB("Physical", s.type2, 2, 100, 100, "01&60");
                                    a1 = new Move(a);
                                    temp.AddMove(a1);
                                }
                            }
                            ...
                            {
                                MoveB b = new MoveB("Special", s.type1, 2, 100, 100, "01&60");
                                Move b1 = new Move(b);
                                temp.AddMove(b1);
                                if (s.type2 != 0)
                                {
                                    b = new MoveB("Special", s.type2, 2, 100, 100, "01&60");
                                    b1 = new Move(b);
                                    temp.AddMove(b1);
                                }
                            }
